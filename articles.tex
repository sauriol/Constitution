...
\asubsection{Text of the Constitution}
All text of the Constitution must be written in the closest possible approximation the format used by \href{https://github.com/JimDaGuy/emojispell}{emojispell} and \href{https://github.com/shawnrc/kemohno}{kehmohno} as well as future emojifying apps.
If significant changes are made to how the most commonly used emojifying app, the text of the Constitution will be updated by the Maintainers to match.
...
\begin{itemize}
    ...
    \item Ensure that the text of the Constitution is up-to-date, as defined in \ref{Text of the Constitution}
\end{itemize}
